...
0.13.2 keeps the chunked subtractive ore renderer and adds coarse live ore remeshing while digging, plus exportable diagnostics with one-second samples and spike/mesh events.
